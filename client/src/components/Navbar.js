    ...
    <>
      <div
        ...
        <div className="h-screen w-screen fixed flex justify-end bg-black bg-opacity-40">
          <div className="h-screen w-screen relative" onClick={toggleDrawer}>
          </div>
            <div
              className={`absolute right-0 w-3/5 bg-darker-gray h-full z-100 p-4 flex gap-4 flex-col ease-in-out duration-500 ${
              ...
              <div className="flex flex-col text-xl text-white font-bold gap-2">
                ...
                <div className="border-b border-white-500 py-2">
                  <NavLink to={"/register"} onClick={toggleDrawer}>
                    Register
                  </NavLink>
                </div>
                <div className="border-b border-white-500 py-2">
