  ...
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-black text-white">
      ...
      <header
        ...
        <p className="pt-2 text-xl bg-black bg-opacity-50 w-full text-center lg:text-3xl md:p-0 lg:bg-opacity-0">
          Learn any language from native.
        </p>
        <h1 className="text-3xl font-bold bg-black bg-opacity-50 w-full mx-8 px-2 pb-2 text-center mb-2 md:text-7xl md:mb-8 md:bg-opacity-0 md:p-0">
      ...
      <main className="container mx-auto min-h-screen lg:min-h-max py-4">
        ...
        <div className="flex flex-col items-center px-8 justify-center flex-1 lg:max-w-screen-sm lg:mx-auto my-16">
          <h1 className="text-center font-bold text-4xl py-2 mb-4">Stefanie and Anne connect on Linguagram...</h1>
          <h3 className="text-lg lg:text-2xl font-light text-center mb-4">...and use Linguagram to practice their target language together! Stefania helps Anne with German and Anne helps Stefania with English</h3>
          <h3 className="text-lg lg:text-2xl font-light text-center mb-8">Join Stefania and Anne and start improve your language!</h3>
          <button className="bg-main-color rounded py-2 px-8 ">
            Get Started
          </button>
        </div>
